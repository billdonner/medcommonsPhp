...
def main(args):
	...
	print >>stderr, "Usage: python test_tracking_number_set.py {appliance} [url"
	exit(1)
    else:
	url = URL
    ...
    print "This allocates a HUGE number of tracking numbers!"
    ...
    while True:
        try:
            while True:
                batch = get_batch(generator.next_tracking_number_set)

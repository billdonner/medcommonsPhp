...
"<input type='hidden' name='returnurl2'value='http://www.medcommons.net/alreadyin.php'/>"+
"<input type='hidden' name='returnurl' value='http://www.medcommons.net/badtracknum.php'/> MedCommons ID or Tracking Number"+

  ...
  <?else:?>
    <?if($info->practice && !$patientMode):?>
      ...
      <div class='dashboardmsg'>
        <p style='margin-bottom: 10px;'><img style='position: relative; left: -3px; top: 3px;' src='images/infoicon.png'/> You don't have any patients yet.  To get started, try the following: </p>
        <p>

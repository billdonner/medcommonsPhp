...
$insert="INSERT INTO groupproperties(groupinstanceid, property, value, comment)
				VALUES('$id','$name','$value', '$comment')";
$result = mysql_query ($insert);
$err = mysql_error();
if ($err!='') 	group_error ($info, "Duplicate property, please remove first - $err"); //does not return
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
      <head>
        ...
        <style type="text/css" media="all"> @import "groups.css"; </style>
                ...
                title="Add Group Property" /></a>
                </td><td>Add Group Property<small> 
                &nbsp;
...
$info->header
<p>$err</p>
<form action=addgroupproperty.php method=post>

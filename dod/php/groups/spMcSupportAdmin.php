...
$desc = "MedCommons Customer Support Admin";
$title = 'Customer Support Page';
$startpage='groups/spSupportAdmin.php';
$top = make_group_page_top ($info,$accid,$email,$id,$desc,$title,$startpage);
$middle = <<<XXX
<div>
<p>The following functions are available to you as MedCommons Support Admin/p>
<ul>
<li><a href='showGroups.php'>Show All Groups on MedCommons</a></li>
<li><a href='modGroups.php?id=$id'>Add Or Remove Members from this Support Group</a></li>
</ul>
</div>
XXX;

...
<fb:fbml version='1.1'>
  ...
  <fb:explanation>
    <fb:message>Documents in  <fb:name uid='<?=$user?>' possessive=true  linked=false useyou=true /> HealthURL</fb:message>
    Clicking a CCR will download the XML, other documents may open in their own application.
    <br/>
    <br/>
    <fb:iframe src='<?=$u->getTargetUser()->authorize($u->appliance."acct/accountDocuments.php?t=widget&accid=".$u->targetmcid,$u)?>' smartsize='true' frameborder='0'/>
  </fb:fbml>
<?

...
<fb:fbml version='1.1'>$dash
  ...
  <fb:success>
    ...
    <span class=hbcounter>($b->hurlcount)</span></a></fb:message> 
  </fb:success>
  </fb:fbml>
XXX;
}
...
<fb:fbml version='1.1'>$dash
  ...
  <fb:explanation>
    <fb:message>Post a Public Health URL to  Topic <a title='view this page HealthBook' href='topics.php?ord=$ord' >$b->nlmtopic</a></fb:message> 
      <p>Enter the healthURL you want to post, and a brief comment. </p>    
      $img
    ...
    <input type=hidden name=posthurl value=posthurl/>
     <fb:editor-text name="healthurl" label="MedCommons Health URL" value=""/>
          <fb:editor-text name="comment" label="comment" value=""/>
     <fb:editor-buttonset>
...
if (isset($_REQUEST['apply']))
{
	...
	if (isset($_REQUEST['explanation']))
	{
		...
		$body = $explanation."<br/><br/>THIS MESSAGE IS FOR THE HEALTHBOOK EDITOR IN CHIEF <br/>
<br/>visit http://www.facebook.com/group.php?gid=$gid to examine the group
<br/>visit http://www.facebook.com/profile.php?gid=$uid to see the  submitter's profile ($fn $ln)
<p><i>
$fn $ln says $explain 
</i></p>
...
<fb:explanation><fb:message>Topic  <a title='view this page on NLM' target='_new' href='$b->nlmurl' >$b->nlmtopic<span class=hbcounter >($b->hurlcount)</span></a> $favmsg   </fb:message>
	<table><tr><td>

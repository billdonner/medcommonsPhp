...
<div class=field><span class=n>&nbsp;&nbsp;</span><span class=q><input type=submit value='Pay via Credit Card' /></span></div>
<br/>
</form>
XXX;
...
$header = page_header_cond("page_payinpersoncc","Pay $mony Online By Credit Card  - MedCommons on Demand" );
$footer = page_footer();
$markup = '<div id="ContentBoxInterior" mainTitle="Pay Online By Credit Card forMedCommons Voucher" >'.
"<h2>You are paying $mony by credit card online</h2>".file_get_contents("payinpersonvoucher.html");
...
<table class=tinst >
<tbody >
<tr ><td class=lcol >Instructions</td><td class=rcol >Please enter your credit card information.
<br/>Your card is not kept on file and will need to be re-entered for every transaction.
<br/>You can also pay via your <a href=voucherclaimpay.php>Amazon Payments</a> account.</td></tr>
</tbody>
</table>
</div>
XXX;

...
if ($c1=='')
$logoninfo = <<<XXX
<a href='login.html' target='_parent'>logon</a>
XXX;
	...
	$logoninfo = <<<XXX
<a href="https://secure.test.medcommons.net/goStart.php" target='_parent'>$accid</a>&nbsp;<a href='logout.php' target='contentwindow' onclick='showContentFrame();'>logout</a>
XXX;
}

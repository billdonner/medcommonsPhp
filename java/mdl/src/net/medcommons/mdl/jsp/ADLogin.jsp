        ...
        <table style="vertical-align: top;">
            <tr>
                <td style="width: 25%; vertical-align: top;">
                    ...
                    <stripes:errors action="/ADLogin.action"/>

                    <stripes:form action="/ADLogin.action" focus="">
                        <table>
                            <tr>
                ...
                <td style="vertical-align: top;">
                    <c:choose>
                        <c:when test="${empty user}">
                            ...
                            <p>
                            Two existing accounts are "doctor" and "clerk" - both with password "tester". 
                            </p>
                            
                              <p>
                           At HIMSS this will log into an IdP. 
                            </p>
                        </c:when>

...
/**
 * PDQ Complete ID Search - Single Domain
     * Test case 11325 covers a complete ID search within a single domain 
     * that is specified by the PD Consumer. Several ADT messages are sent 
     * to the Patient Demographics Supplier. Then, the PD Consumer sends a 
     * query. The consumer is expected to query with a Patient identifier
     *      PID.3.1 = PDQ113XX02
 ...
 *
 */
public class MesaPDC11325Action extends MesaBaseAction{

	private static Logger logger = Logger.getLogger(MesaPDC11325Action.class);
	 
	 public void executeTest() throws Exception{
		
	     setTestname("PDC 11325");
	     
	     OhfBridgeSoapBindingStub binding = null;
	      binding=createBinding();
	      
	      PatientIdType idType = new PatientIdType();
	      idType.setIdNumber("PDQ113XX02");

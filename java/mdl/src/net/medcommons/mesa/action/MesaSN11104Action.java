 ...
 *
 */
public class MesaSN11104Action extends MesaBaseAction implements AtnaConstants{

	
	private static Logger logger = Logger.getLogger(MesaSN11104Action.class);
	 public void executeTest() throws Exception{
		
	     setTestname("SN 11104");
      ...
      */
      ...
      for(int i = 0; i < fRhios.length; i++){
          try{
          	...
          	String initiatingUserName = "doctor";
          	String initiatingUserNodeIP = "192.168.0.106";
          	String authenticatingNodeIP = "192.168.0.104";
          	
          	response= binding.auditUserAuthenticationLoginEvent(sessionContext, eventOutcome, 
          			initiatingUserName, initiatingUserNodeIP, authenticatingNodeIP);
          	String message = null;

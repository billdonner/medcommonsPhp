 ...
 *
 */
public class MesaSN11121Action extends MesaBaseAction implements AtnaConstants{

	
	private static Logger logger = Logger.getLogger(MesaSN11121Action.class);
	 public void executeTest() throws Exception{
		
	     setTestname("SN 11121");

 ...
 *
 */
public class MesaXDS11734Action extends MesaBaseAction {

	private static Logger logger = Logger.getLogger(MesaXDS11734Action.class);

	public void executeTest() throws Exception {

		setTestname("XDS 11734");

		OhfBridgeSoapBindingStub binding = null;
		binding = createBinding();

		PatientIdType idType = new PatientIdType();
		idType.setIdNumber("JM19400814");

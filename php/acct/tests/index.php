...
global $is_test;
$is_test = true;
require_once("ApplicationKeyTest.php");
require_once("AuthenticationTokenTest.php");
require_once("HidePatientTest.php");
...
$test = new TestSuite('MedCommons Account Services Tests');
$test->addTestCase(new AuthenticationTokenTest());
$test->addTestCase(new HidePatientTest());
$test->addTestCase(new WorkflowTest());
$test->addTestCase(new ApplicationKeyTest());

...
$leagueind= mysql_fetch_object($result)->ind;


echo "nbaspider.php: reading nba sites not writing player healthurls currently<br/>";
...
'$hp', '$sched', '$rss', '$img', '$teamname'
	...
	$teamind = mysql_insert_id();

dosql ("REPLACE INTO `leagueteams` (
`teamind` ,
`leagueind` 
...
$playerind = mysql_insert_id();						
dosql ("REPLACE INTO `teamplayers` (
`teamind` ,
`playerind` 

...

{
	...
	$out.= <<<XXX
	<li id='cat$topcat' >
	<a  href='#' onclick="tog('sub$topcat');"><img  src='../images/bluecycle8x8.gif' /></a>&nbsp;<a href='$link' class='$aclass' >$label</a>
	                    </li>\r\n
XXX;
	$count++;
	...
	mysql_free_result($qqqresult);
           if ($clones>0) $aclass='clones'; else $aclass='tiny';
		$out.= "<li id='cat$topcat-$thiscat'><a class='$aclass' target='_new' href='$ilink'>$ilabel</a>$mlinks</li>\r\n";
		$count++; $thiscat++;
...
file_put_contents('tdir.html',$out);
echo "File <a href='tdir.html'>tdir.html</a> created";
echo "Total of $count entries; max entries in topic $maxtopic is $maxcat<br>";
?>
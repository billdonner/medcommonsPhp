...
if ($___file!='') $f=$___file; else // this file not only executes directly, but is included in createTrackerDB
$f = $_GET['f'];
...
echo ("<br><form action=../../appsrv/appservices.php><input type=submit value='Ok'></form>");
?>
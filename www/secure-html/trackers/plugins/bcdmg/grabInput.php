...
$html= <<<XXX
<html><head><title> BCDMG- Get Tracker Input for $tracker</title>
        <link rel="shortcut icon" href="images/favicon.gif" type="image/gif"/>
        <style type="text/css" media="all"> @import "../../gadget.css"; </style>

</head>
<body bgcolor='#FFFF99'><table><tr><td><a href="index.html" ><img border="0" alt="$tracker" 
                src="../../images/bloodcounters.jpg" 
                title="My Trackers from BloodCounters.org" /></a>
                </td><td>My BloodCounter Trackers <small><i>enter new values</i>
